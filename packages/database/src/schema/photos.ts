...
export const photos = mysqlTable(
    "photos",
    {
        ...
        variant: mysqlEnum(["desktop", "mobile", "default", "inline"]).notNull().default("default"),
    ...
    (table) => [
        index("photoType_parentId_variant_idx").on(table.photoType, table.parentId, table.variant),
    ],
)
