...
const contentData: ContentSeedItem[] = [
  ...
  ...[
    ...
    { slug: 'volunteer-fostering', sortOrder: 5, data: { label: 'Fostering', title: 'The Lifeblood of GPA-MN', description: 'We foster every dog rather than kennel them. Foster families provide a safe, loving environment where greyhounds learn about home life — stairs, glass doors, couches, and the simple joy of being a pet.', location: 'Volunteer — Fostering' } },
    { slug: 'volunteer-roles', sortOrder: 6, data: { label: 'Volunteer Roles', title: 'Find Your Role', description: 'There are many ways to get involved with GPA-MN. Find the volunteer opportunity that fits your skills and schedule.', location: 'Volunteer — Roles' } },
    ...
    { slug: 'about-history-timeline', sortOrder: 13, data: { label: 'Timeline', title: 'Key Milestones', location: 'About / History — Timeline' } },
    { slug: 'contact-message', sortOrder: 14, data: { label: 'Send a Message', title: 'Drop Us a Line', location: 'About / Contact — Message Form' } },
    { slug: 'contact-info', sortOrder: 15, data: { label: 'Contact Info', title: 'Other Ways to Reach Us', location: 'About / Contact — Contact Info' } },
  ].map((item) => ({ ...item, contentType: 'sectionHeader' as const })),

  // Page headers
  ...[
    { slug: 'adopt-process', sortOrder: 0, data: { badge: 'Adoption Process', title: 'Our Adoption Process', highlight: 'Adoption Process', description: 'Our primary obligation is to the dogs entrusted to our care. We\'ve developed a thorough process over 30+ years to ensure successful, life-long adoptions.', location: 'Adopt / Our Process' } },
    { slug: 'about-history', sortOrder: 1, data: { badge: 'Our History', title: '35+ Years of Saving Lives', highlight: 'Saving Lives', description: 'From a small group of greyhound enthusiasts to one of Minnesota\'s most respected adoption organizations, here\'s our journey.', location: 'About / History' } },
    { slug: 'about-contact', sortOrder: 2, data: { badge: 'Get In Touch', title: 'Contact Us', highlight: 'Contact', description: 'Have questions about adoption, volunteering, or our organization? We\'d love to hear from you.', location: 'About / Contact' } },
    { slug: 'about', sortOrder: 3, data: { badge: 'About Us', title: 'About GPA-Minnesota', highlight: 'GPA-Minnesota', description: 'Greyhound Pets of America — Minnesota is an all-volunteer, 501(c)(3) nonprofit organization dedicated to finding loving homes for retired racing greyhounds in the Twin Cities area.', location: 'About' } },
    { slug: 'adopt-available', sortOrder: 4, data: { badge: 'Available Dogs', title: 'Meet Our Greyhounds', highlight: 'Greyhounds', description: 'Each of these gentle souls is looking for their forever home. Browse our available dogs and find your perfect match.', location: 'Adopt / Available Dogs' } },
    { slug: 'adopt', sortOrder: 5, data: { badge: 'Adopt a Greyhound', title: 'Your New Best Friend is Waiting', highlight: 'Best Friend', description: 'Greyhounds make wonderful family pets. They are gentle, affectionate, and surprisingly low-energy couch companions. Ready to open your heart and home?', location: 'Adopt' } },
    { slug: 'adopt-support', sortOrder: 6, data: { badge: 'Post-Adoption', title: 'Post-Adoption Support', highlight: 'Support', description: 'Congratulations on your new family member! We\'re here to help you and your greyhound thrive together.', location: 'Adopt / Support' } },
    { slug: 'donate', sortOrder: 7, data: { badge: 'Support Our Mission', title: 'Help Us Save More Greyhounds', highlight: 'Save More Greyhounds', description: 'Your generous donation helps cover veterinary care, foster supplies, transportation, and everything needed to give these gentle dogs a second chance at life.', location: 'Donate' } },
    { slug: 'events', sortOrder: 8, data: { badge: 'Join Us', title: 'Upcoming Events', highlight: 'Events', description: 'From our signature fundraiser to casual weekend walks, there are plenty of ways to connect with our community and the greyhounds.', location: 'Events' } },
    { slug: 'lost-hound', sortOrder: 9, data: { badge: 'Emergency', title: 'Lost Hound!', highlight: 'Lost Hound!', description: 'If your greyhound has gotten loose, time is critical. Follow these steps immediately.', variant: 'urgent', location: 'Lost Hound' } },
    { slug: 'volunteer', sortOrder: 10, data: { badge: 'Make a Difference', title: 'Volunteer with GPA-MN', highlight: 'Volunteer', description: 'GPA-MN is powered entirely by volunteers like you. Whether you have a few hours a month or want to be deeply involved, there is a role for you.', location: 'Volunteer' } },
    { slug: 'home', sortOrder: 11, data: { badge: 'Welcome', title: 'Finding Loving Homes for Retired Racing Greyhounds', highlight: 'Loving Homes', description: 'Every greyhound deserves a soft bed, a warm home, and a family to call their own. GPA-MN has been making that happen for over 35 years.', location: 'Home' } },
...
- All adopters are invited to join our Facebook community for ongoing support.`,
  ...
  ...[
    { slug: 'new-hound-owners-manual', sortOrder: 0, data: { title: "New Hound Owner's Manual", description: 'Everything you need to know about bringing your greyhound home — from the first night to establishing routines.', icon: '📖' } },
    { slug: 'heartworm-prescription-note', sortOrder: 1, data: { title: 'Heartworm Prescription Note', description: 'Information about heartworm prevention and how to obtain prescriptions for your adopted greyhound.', icon: '💊' } },
    { slug: 'preventing-escapes', sortOrder: 2, data: { title: 'Preventing Escapes', description: 'Tips and best practices for preventing your greyhound from getting loose, including collar and leash recommendations.', icon: '🔒' } },
    { slug: 'stay-connected', sortOrder: 3, data: { title: 'Stay Connected', description: 'Join the MN Greyhound Playdates, Outings, Hijinks, Chat and Support Facebook group for ongoing community support.', icon: '🤝' } },
    { slug: 'feeding-guidelines', sortOrder: 4, data: { title: 'Feeding Guidelines', description: 'Recommended food brands, portion sizes, and feeding schedules tailored specifically for retired racing greyhounds.', icon: '🍽️' } },
    { slug: 'veterinary-care', sortOrder: 5, data: { title: 'Veterinary Care', description: 'Greyhound-specific health information including dental care, anesthesia sensitivities, and recommended vet practices in the Twin Cities.', icon: '🏥' } },
  ].map((item) => ({ ...item, contentType: 'postAdoptionSupport' as const })),

  // Lost hound suggestions (prevention tips)
  ...[
    { slug: 'id-tags', sortOrder: 0, data: { title: 'ID Tags', description: "Always keep current ID tags on your greyhound's collar with your phone number. Consider a GPS tracking collar.", icon: '🏷️' } },
    { slug: 'martingale-collar', sortOrder: 1, data: { title: 'Martingale Collar', description: 'Use a properly fitted martingale collar — greyhounds can slip out of regular collars due to their narrow heads.', icon: '🔗' } },
    { slug: 'door-safety', sortOrder: 2, data: { title: 'Door Safety', description: 'Be vigilant about doors and gates. Greyhounds are fast and can bolt before you realize it. Consider baby gates as backup.', icon: '🚪' } },
    { slug: 'secure-fencing', sortOrder: 3, data: { title: 'Secure Fencing', description: 'Check your yard fencing regularly for gaps. Greyhounds can squeeze through surprisingly small spaces and can jump fences under 5 feet.', icon: '🏡' } },
    { slug: 'microchip', sortOrder: 4, data: { title: 'Microchip', description: "Ensure your greyhound's microchip registration is up to date with your current contact information.", icon: '📱' } },
    { slug: 'leash-always', sortOrder: 5, data: { title: 'Leash Always', description: 'Never let your greyhound off-leash in an unfenced area. Their prey drive can override all training in an instant.', icon: '⚡' } },
  ].map((item) => ({ ...item, contentType: 'lostHoundSuggestion' as const })),

  // Why greyhounds
  ...[
    { slug: 'gentle-temperament', sortOrder: 0, data: { title: 'Gentle Temperament', description: 'Greyhounds are known for being calm, quiet, and surprisingly low-energy in the home. They are the ultimate couch companion.', icon: '🛋️' } },
    { slug: 'great-with-families', sortOrder: 1, data: { title: 'Great with Families', description: 'Most greyhounds are wonderful with children and adapt well to family life. Their gentle nature makes them patient and loving pets.', icon: '👨‍👩‍👧' } },
    { slug: 'low-grooming-needs', sortOrder: 2, data: { title: 'Low Grooming Needs', description: 'With short coats and minimal shedding, greyhounds are easy to groom. A weekly brush and occasional bath is all they need.', icon: '✂️' } },
    { slug: 'calm-house-dogs', sortOrder: 3, data: { title: 'Calm House Dogs', description: 'Despite being the fastest dog breed, greyhounds are surprisingly lazy at home. They typically sleep 16–18 hours a day.', icon: '🏡' } },
