  ...
  return (
    <section
      className={cn(
        ...
        variant === 'default' &&
          'bg-linear-to-br from-[#FAF5F0] via-[#f0ebe4] via-60% to-secondary/30 dark:from-[#1a1715] dark:via-[#1e1b17] dark:via-60% dark:to-[#152628]',
        variant === 'urgent' &&
          'bg-linear-to-br from-[#FAF5F0] via-[#fce0dd] to-primary/20 dark:from-[#1a1715] dark:via-[#211211] dark:to-primary/10',
        className
      )}
    >
      ...
      <div className="relative z-10 max-w-300 mx-auto text-center">
        ...
        {description && (
          <p className="text-lg text-muted-foreground leading-relaxed max-w-130 mx-auto mb-8">
            {description}
          </p>
        )}
