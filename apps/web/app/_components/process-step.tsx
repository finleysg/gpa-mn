import type { AdoptionStepData } from '@repo/types';
import { MarkdownContent } from './markdown-content';

export function ProcessStep({ step }: { step: AdoptionStepData }) {
  return (
    <div className="flex gap-4 items-start">
      ...
      <div>
        ...
        <MarkdownContent content={step.description} className="text-[0.95rem] text-muted-foreground leading-relaxed mb-3 [&>p]:mb-0" />
