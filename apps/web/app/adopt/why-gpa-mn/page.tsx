...
export default async function WhyGpaMnPage() {
    ...
    return (
        <>
            <section
                aria-labelledby="why-gpa-mn-heading"
                className="to-secondary/30 relative overflow-hidden bg-linear-to-br from-[#FAF5F0] via-[#f0ebe4] via-60% px-5 py-20 pt-36 md:py-24 md:pt-44 dark:from-[#1a1715] dark:via-[#1e1b17] dark:via-60% dark:to-[#152628]"
            >
                <BlobDecoration
                    color="pink"
                    size={500}
